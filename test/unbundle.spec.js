...
describe("ogy application level tests - unbundle", () => {
    ...
    it("setup test data files", () => {
        fs.copyFile(__dirname + "/data/mad/CARD_Desc-987362f9.bundle", __dirname + "/CARD_Desc-987362f9.bundle", (err) => { if (err)
            throw err; });
        fs.copyFile(__dirname + "/data/mad/CARD_Indx-e9aa18bf.bundle", __dirname + "/CARD_Indx-e9aa18bf.bundle", (err) => { if (err)
            throw err; });
        fs.copyFile(__dirname + "/data/mad/CARD_Name-cde5b0ab.bundle", __dirname + "/CARD_Name-cde5b0ab.bundle", (err) => { if (err)
            throw err; });
        fs.copyFile(__dirname + "/data/mad/Card_Part-ebaee097.bundle", __dirname + "/Card_Part-ebaee097.bundle", (err) => { if (err)
            throw err; });
        fs.copyFile(__dirname + "/data/mad/Card_Pidx-f09348d3.bundle", __dirname + "/Card_Pidx-f09348d3.bundle", (err) => { if (err)
            throw err; });
        fs.copyFile(__dirname + "/data/mad/Card_Pidx-494e34d0.bundle", __dirname + "/Card_Pidx-494e34d0.bundle", (err) => { if (err)
            throw err; });
    });
    /*
   ...
   */
    it("unbundling of CARD_Desc should work and produce a CAB and a meta file", async () => {
        ...
        const extractedFiles = await assetBundle.extractAssetBundle(__dirname);
    ...
    it("repackaging CARD_Name bundle should work and produce identical output", async () => {
        ...
        assert.equal(Buffer.compare(reextractedAsset, originalAssetData), 0, "Repackaged asset should match original");
...
//# sourceMappingURL=unbundle.spec.js.map